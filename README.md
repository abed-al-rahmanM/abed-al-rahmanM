...
<details>
<p><strong> <summary>  Busy coding & Learning to :   </summary> </strong></p>

🎧 Right now I’m learning and building projects — no music widget yet 🙂  
...
public:
    void learn() {
        study("C basics");
        practice("pointers, arrays, memory");
        improve("C++ OOP: classes, constructors");
    }
};
